...
export const PieceSpriteSheet: React.FC = () => (
  <svg style={{ display: 'none' }} xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol id="piece-n" viewBox="0 0 100 100">
       ...
       <circle cx="62" cy="27" r="3.5" fill="currentColor" stroke="none" />
    </symbol>
    ...
    <symbol id="piece-b" viewBox="0 0 100 100">
      ...
      <circle cx="41" cy="35" r="3.2" fill="currentColor" stroke="none" />
      <circle cx="59" cy="35" r="3.2" fill="currentColor" stroke="none" />
    </symbol>
